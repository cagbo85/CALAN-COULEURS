...
class ArtisteController extends Controller
{
    ...
    public function storePerformance(Request $request, $editionId)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'scene' => 'nullable|in:Nalac,La Cabane',
            ...
            'scene.in' => 'La scène de la performance doit être "Nalac" ou "La Cabane".',
    ...
    public function update(Request $request, string $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'performances.*.scene' => 'nullable|in:Nalac,La Cabane',
            ...
            'performances.*.scene.in' => 'La scène de la performance doit être "Nalac" ou "La Cabane".',
