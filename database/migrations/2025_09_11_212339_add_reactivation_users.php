...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('reactivation_requested_by')->nullable()->after('reactivation_requested_at');
            $table->timestamp('reactivation_approved_at')->nullable()->after('reactivation_requested_by');
            $table->unsignedBigInteger('reactivation_approved_by')->nullable()->after('reactivation_approved_at');
