...
class StandSeeder extends Seeder
{
    public function run()
    {
        ...
        DB::table('stands')->insert([
            ...
            [
                'name' => '🛟 Tulipea Bijoux',
                'description' => 'Créatrice de bijoux en acier inoxydable.',
                'photo' => 'img/surplace/Tulipea Bijoux.webp',
                'type' => 'boutique',
                'instagram_url' => 'https://www.instagram.com/tulipea__bijoux/',
                'facebook_url' => null,
                'website_url' => null,
                'other_link' => null,
                'ordre' => 8,
            ...
            [
                'name' => '🛟 La Fouée',
                'description' => 'Des fouées Authentiques et Artisanales.',
                'photo' => 'img/surplace/La Fouée.webp',
                'type' => 'foodtruck',
                'instagram_url' => 'https://www.instagram.com/lafouee/',
                'facebook_url' => null,
                'website_url' => null,
                'other_link' => null,
                'ordre' => 9,
            ...
            [
                'name' => '🛟 Shefu Burger',
                'description' => 'Des burgers gourmands et savoureux.',
                'photo' => 'img/surplace/Shefu Burger.webp',
                'type' => 'foodtruck',
                'instagram_url' => 'https://www.instagram.com/shefuburger/',
                'facebook_url' => null,
                'website_url' => 'https://shefuburger.fr/',
                'other_link' => null,
                'ordre' => 10,
                'created_by' => 1,
                'updated_by' => 1,
