...
export default function PartnersSection() {
    ...
    // Etat vide (partenaires non encore annoncés)
                        ...
                        <article className="bg-white/95 backdrop-blur-sm rounded-xl shadow-xl overflow-hidden border-2 border-white/50">
                            ...
                            <div className="p-8 text-center">
                                <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                                    Les partenaires de cette édition seront
                                    annoncés prochainement.
                                </p>
                                <p className="text-base text-gray-600 mb-6">
                                    Revenez bientôt pour découvrir celles et
    ...
    // Etat normal (partenaires disponibles)
    return (
        <section
        ...
        >
            <div className="container mx-auto">
                <div className="text-center mb-12">
                    ...
                    >
                        Ils nous accompagnent et nous soutiennent pour faire de
                        Calan'Couleurs une expérience unique.
                    </p>
                </div>
                        ...
                        return (
                            ...
                            >
                                <div
                                    ...
                                    style={{
                                        background:
                                            "linear-gradient(135deg, #8F1E98 0%, #FF0F63 100%)",
                                    }}
                                >
                                ...
                                <div className="p-6">
                                    ...
                                    {partner.phone && (
                                        <div className="flex items-center text-gray-600 text-sm mb-4">
                                            <svg
                                                className="w-4 h-4 text-[#FF0F63] mr-2 flex-shrink-0"
                                                fill="currentColor"
                                                viewBox="0 0 20 20"
                                            >
