            ...
            <div id="tab-principe" class="tab-content" role="tabpanel">
                ...
                <div class="text-center">
                    <button
                        ...
                        data-goto="inscription" style="background: linear-gradient(90deg, #272ac7 0%, #8f1e98 100%)">
            ...
            <div id="tab-inscription" class="hidden tab-content" role="tabpanel">
                ...
                <div class="max-w-2xl mx-auto">
                    <div class="mb-6 overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
                        <div class="px-6 py-4" style="background: linear-gradient(90deg, #272ac7 0%, #8f1e98 100%);">
                            <h3 class="flex items-center gap-2 text-xl font-semibold text-white">
                                📋 Avant de cliquer…
                            </h3>
                        </div>
                        <div class="p-6 space-y-2 text-gray-700">
                            <p class="flex items-start gap-2">
                                <span class="text-[#272AC7] font-bold"><i class="fa-solid fa-check"></i></span>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function activateTab(targetTab) {
                ...
                if (targetButton) {
                    targetButton.classList.add('tab-active', 'border-[#272AC7]', 'text-[#272AC7]');
