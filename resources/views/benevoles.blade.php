...
@section('content')
    <div class="w-full min-h-screen px-4 py-12 pt-8 sm:px-6 lg:px-8 bg-gray-50">
            ...
            <div id="tab-principe" class="tab-content" role="tabpanel">
                ...
                <div class="grid grid-cols-1 gap-6 mb-10 md:grid-cols-2">
                    <div class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
                        <div class="px-6 py-4" style="background: linear-gradient(135deg, #FF0F63 0%, #8F1E98 100%);">
                ...
                <div class="text-center">
                    <button
                        ...
                        data-goto="inscription" style="background: linear-gradient(135deg, #FF0F63 0%, #8F1E98 100%)">
                        Je m'inscris avec mon binôme →
                    </button>
                </div>
            </div>
                    ...
                    <div class="mb-6 overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
                        ...
                        <div class="p-6 space-y-2 text-gray-700">
                            <p class="flex items-start gap-2">
                                <span class="text-[#FF0F63] font-bold">✓</span>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function activateTab(targetTab) {
                ...
                if (targetButton) {
                    targetButton.classList.add('tab-active', 'border-[#FF0F63]', 'text-[#FF0F63]');
