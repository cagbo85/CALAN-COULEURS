...
@section('content')
    <div class="w-full min-h-screen px-4 py-12 pt-8 sm:px-6 lg:px-8 bg-[#EEF1FF]">
        ...
        <div class="grid gap-8 mx-auto mb-10 max-w-7xl md:grid-cols-2">
            <div class="overflow-hidden bg-white border border-[#272AC7]/15 shadow-sm rounded-xl">
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-lg font-bold text-[#272AC7] mb-3">Temps de trajet depuis</h3>
                    <ul class="space-y-3">
                        <li class="flex items-center text-gray-700">
                            <span class="w-2 h-2 bg-[#272AC7] rounded-full mr-3"></span>
                    ...
                    <div class="mt-6 space-y-3">
                        <a href="https://www.google.com/maps?q=47.4226619,-1.9234608333333332" target="_blank"
                            ...
                            class="inline-flex items-center gap-2 bg-[#272AC7] text-white px-4 py-2 rounded-lg font-semibold hover:bg-[#8F1E98] transition w-full justify-center">
                        ...
                        <a href="https://waze.com/ul?ll=47.4226619,-1.9234608333333332&navigate=yes" target="_blank"
                            rel="noopener noreferrer"
                            class="inline-flex items-center gap-2 bg-[#2A7BFF] text-white px-4 py-2 rounded-lg font-semibold hover:bg-[#1F63CF] transition w-full justify-center">
            ...
            <div class="overflow-hidden bg-white border border-[#272AC7]/15 shadow-sm rounded-xl flex flex-col h-full">
        ...
        <div class="max-w-4xl mx-auto mt-2 text-gray-700">
            <h2 class="text-2xl font-bold text-[#272AC7] mb-4">Parking & Covoiturage</h2>
            <p class="mb-4">
            ...
            <p>
                <a href="https://www.blablacar.fr/" target="_blank" rel="noopener noreferrer"
                    class="font-semibold text-[#272AC7] hover:text-[#8F1E98] underline">
                    Ouvrir BlaBlaCar
                </a>
            </p>
        </div>
